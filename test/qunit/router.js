window.addEvent('domready', function() {
  ...
  module("Moovoodoo.Router");

  var Router = new Class({

    Extends: Moovoodoo.Router,
  ...
  Moovoodoo.history = null;
  var router = new Router({testing: 101});

  Moovoodoo.history.interval = 9;
  Moovoodoo.history.start({pushState: false});
  ...
  asyncTest("Router: routes (two part)", 2, function() {
    ...
    setTimeout(function() {
      console.log('search/nyc/p10 : ' + window.location.hash);
