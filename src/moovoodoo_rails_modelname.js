//
//     Moovoodoo.Rails_ModelName.js
//
//     Makes moovoodoo.js play nicely with the default Rails setup, i.e.,
//     no need to set
//       ActiveRecord::Base.include_root_in_json = false
//     and build all of your models directly from `params` rather than
//     `params[:model]`.
//
//     Load this file after moovoodoo.js and before your application JS.
//

Moovoodoo.Model.implement({
